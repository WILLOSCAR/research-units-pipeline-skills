...
- H3 target: fewer, thicker subsections (per `draft_profile`: course_paper<=6, survey<=10, deep<=12)
...
- If `queries.md` sets `draft_profile` (`course_paper`/`survey`/`deep`), use it to decide the H3 budget target.
