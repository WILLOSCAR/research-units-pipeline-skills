...
| course paper / term report | `arxiv-survey` 또는 `arxiv-survey-latex` 를 재사용하는 use-case overlay | report draft, optional PDF | [Guide EN](arxiv-survey.md) |
...
| `graduate-paper` | 중국어 thesis 자료 재구성. research-stage 이며 executable pipeline 은 아님 | thesis design artifacts + skill packages | [Guide EN](graduate-paper.md) |

## 병렬인 3가지 Research Judgment Entry
