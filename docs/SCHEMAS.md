...
|---|---|---|---|---|
| `skill-audit-report.v1` | `uv run python scripts/audit_skills.py --format json` | `scripts.audit_skills.build_report_payload` | `scripts.audit_skills.validate_skill_audit_payload` | `docs/adr/0004-keep-skill-audit-as-repo-local-json-before-sarif.md` |
