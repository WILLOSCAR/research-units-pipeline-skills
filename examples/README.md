...
| [`paper-review-current-engine-proof`](paper-review-current-engine-proof/README.md) | one synthetic manuscript, one topic; current typed engine over `.harness-v3` | a fresh, reproducible end-to-end paper-review run through the typed engine: real skills, 9/9 Units, `COMPLETED`, six produced Artifacts with stable hashes | research quality, cross-topic stability, real-manuscript proof, and expert review |
